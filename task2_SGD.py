...
def validate(model, validation_set):
    ...
    for data_x, data_y in validation_set:
        ...
        # get the class of the data on the dataset
...
def main():
    ...
    model = NeuralNetwork()
    layer_config = [
        {'input_size': 4, 'output_size': 5, 'normalize': DirectLayer(), 'activation': Tanh()},
        {'input_size': 5, 'output_size': 3, 'normalize': DirectLayer(), 'activation': Tanh()},
